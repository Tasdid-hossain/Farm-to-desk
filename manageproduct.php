...
<?php
    ...
    <div class="row" >
      <div class="large-12">
        <h3 style="margin-top:100px;text-align:center;">Available Products</h3>
        <hr>
		...
		<table id="myTable" class="table table-active">
			<tr class="header">
				...
				<th style="width:60%;">Delete Product</th>
        ...
        <?php
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
			  ...
			  echo '<td><a href="delete-item.php?id=' .$obj->id. '"><button>Delete</button></a>';
			  echo '</td>';
